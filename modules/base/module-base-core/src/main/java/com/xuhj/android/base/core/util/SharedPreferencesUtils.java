...
import com.xuhj.android.base.core.BaseApplication;
...
public class SharedPreferencesUtils {
    ...
    public static SharedPreferences.Editor getSharedEditor() {
        return BaseApplication.getInstance().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE).edit();
    }
    ...
    public static <T extends Object> T getObject(String key, Class<T> clazz) {
        Object object = null;
        String userJson = getString(key, null);
        try {
    ...
    public static <T> List<T> getList(String key, Class<T> clazz) {
        ...
        if (fromJson == null)
            return list;
        JsonArray array = new com.google.gson.JsonParser().parse(fromJson).getAsJsonArray();
