...
public class NetworkUtils {
    ...
    /**
     * 判断是否连网 isAccessNetwork
     *
     * @param context
     * @return
     */
    public static boolean isAccessNetwork(Context context) {
        if (((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo() != null && ((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo().isAvailable())
            return true;
        return false;
    }
