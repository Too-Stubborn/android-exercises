...
import com.xuhj.jellybean.BuildConfig;
...
public class LogUtils {
    ...
    public static final String TAG = Settings.PACKAGE_NAME + ".log";
    ...
    public static String logcat = "[unkown]";
    ...
    private static void writeFileSdcard(String message) {
        try {
            String cf = "\r\n";
            File file = new File(Settings.getLogTxtPath(), fileName);
    ...
    private static String getFunctionName() {
        ...
        for (StackTraceElement st : sts) {
            ...
            if (st.getClassName() != null && st.getClassName().contains("LogUtils"))
                continue;
