...
public class StringUtils {
    ...
    public static boolean isPhone(String strPhone) {
        String strPattern = "^((?:13\\d|14[\\d]|15[\\d]|17[\\d]|18[\\d]|19[\\d]|12[\\d])-?\\d{5}(\\d{3}|\\*{3}))$";
     ...
     * @return
     */
    public static String StringFilterFinal(String str) {
    ...
    public static final String md5(String src) {
        if (src != null) {
            try {
                ...
                return byteToHexString(md5.digest(src.getBytes()));
    ...
    public static final String md5(byte[] src) {
        if (src != null) {
            try {
                MessageDigest md5 = MessageDigest.getInstance("MD5");
                return byteToHexString(md5.digest(src));
            } catch (NoSuchAlgorithmException e) {
                e.printStackTrace();
            }
        }
